"""
Configuration settings for the EDRavenColonialAgent EDMC plugin
"""
...
class PluginConfig:
    """Configuration management for the EDRavenColonialAgent plugin"""
    ...
    def get_api_base() -> str:
        ...
        try:
            ...
            return config.get_str("edrca_api_url") or PluginConfig.DEFAULT_API_BASE
    ...
    def get_user_agent() -> str:
        ...
        return f'EDRavenColonialAgent/{PluginConfig.VERSION}'
